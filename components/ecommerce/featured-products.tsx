...
import { Star, ShoppingCart, Heart, Eye, TrendingUp, Zap, Tag, Loader2 } from "lucide-react"
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-5 lg:gap-6">
          {products.map((product) => {
            ...
            // const badgeStyle = getBadgeStyle(product.badge) // Badge logic might need update if badge is not in DB or different
                ...
                <CardContent className="p-0 relative">
                  ...
                  <Link href={`/produits/${product.id}`} className="block relative">
                    ...
                    <div className="absolute left-2 top-2 sm:left-3 sm:top-3 flex flex-col gap-2">
                      {product.isNew && (
                        <Badge className={cn("backdrop-blur-sm shadow-lg text-xs", "bg-blue-500/90 text-white")}>
